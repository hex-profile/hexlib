...
//================================================================
//
// MessageFormatterFast
//
// Always keeps buffer with NUL character at the end.
//
//================================================================

class MessageFormatterFast : public MessageFormatter
{

private:

    sysinline void writeFunc(const CharType* bufferPtr, size_t bufferSize);
...
public:
    ...
    MessageFormatterFast(const Array<CharType>& memory)
        {setMemory(memory);}
...
private:
    ...
    inline void printInt(const Type& value, const FormatNumberOptions& options);

    template <typename Type>
    inline void printFloat(const Type& value, const FormatNumberOptions& options);
