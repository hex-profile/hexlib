...
void DisplayParamsImpl::serialize(const CfgSerializeKit& kit, bool& altVersionSteady)
{
    check_flag(theAlternativeVersion.serialize(kit, STR("Alternative Version"), STR("a")), altVersionSteady);
