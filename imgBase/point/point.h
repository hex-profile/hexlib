...
VECTOR_BASE_REBASE_VECTOR_IMPL(Point)
TYPE_CONTROL_VECTOR_IMPL(Point)
...
CONVERT_FAMILY_VECTOR_IMPL(Point, PointFamily)
...
POINT_DEFINE_FUNC1(floorv)
POINT_DEFINE_FUNC1(ceilv)
